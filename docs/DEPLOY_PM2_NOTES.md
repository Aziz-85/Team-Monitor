...
## منح صلاحية الأدمن (ADMIN) لمدير الراشد أو موظف (مثلاً 1205)

**من الواجهة (يحتاج أدمن حالي):**
1. الدخول بحساب **ADMIN** أو **SUPER_ADMIN**.
2. من القائمة: **Admin** → **Employees**.
3. البحث عن الموظف (مثلاً رقم 1205 أو مدير الراشد).
4. إذا كان له حساب: الضغط **Edit** بجانب حسابه وتغيير **Role** إلى **ADMIN** ثم **Save**.
5. إذا لم يكن له حساب: **Create account** واختيار الدور **ADMIN** وإدخال كلمة المرور.

**من السيرفر (سكربت مرة واحدة):**  
للموظف الذي رقمه 1205 (أو أي empId آخر):
...
استبدل `1205` برقم الموظف الفعلي إن كان مختلفاً. السكربت يتحقق من وجود المستخدم ويغيّر دوره إلى ADMIN فقط (لا يغيّر SUPER_ADMIN).
