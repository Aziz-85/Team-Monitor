/**
 * GET /api/admin/import-center/templates/yearly-sales?boutiqueId=&year=YYYY
 * ADMIN / SUPER_ADMIN. System-generated yearly sales matrix template for one branch.
 */
  ...
  try {
    ...
    return new NextResponse(new Uint8Array(buf), {
      ...
      headers: {
        ...
        'Content-Disposition': `attachment; filename="YearlySales_${boutiqueId.slice(0, 8)}_${year}.xlsx"`,
      },
    });
  } catch (e) {
