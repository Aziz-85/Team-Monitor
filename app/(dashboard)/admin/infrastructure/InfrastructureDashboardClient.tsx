...
type Dashboard = { enabled: boolean; agentStatus: string; apps: AppRow[]; system?: { loadAverage?: unknown; cpuCount?: unknown; memory?: { free?: unknown }; disk?: { usedPercent?: unknown }; services?: Record<string, unknown> }; error?: string };
