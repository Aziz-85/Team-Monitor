...
const baseEnvSchema = z.object({
  ...
  AUTH_TRUSTED_DEVICE_SECRET: z.string().optional(),
  AUTH_TRUSTED_DEVICES_ENABLED: z.string().optional(),
  AUTH_PASSKEYS_ENABLED: z.string().optional(),
  AUTH_PUSH_APPROVAL_ENABLED: z.string().optional(),
  AUTH_PASSWORDLESS_PASSKEY_ENABLED: z.string().optional(),
