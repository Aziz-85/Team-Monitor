...
const GROUP_REPORTS: NavGroup = {
  ...
  items: [
    { href: '/executive', key: 'nav.reports.performanceOverview', roles: ['ADMIN', 'SUPER_ADMIN', 'MANAGER'] },
    { href: '/executive/monthly', key: 'nav.reports.monthlyPerformance', roles: ['ADMIN', 'SUPER_ADMIN', 'MANAGER'] },
    { href: '/sales/summary', key: 'nav.reports.salesSummary', roles: ['ASSISTANT_MANAGER', 'MANAGER', 'ADMIN', 'SUPER_ADMIN'] },
    { href: '/admin/targets', key: 'nav.reports.targets', roles: ['MANAGER', 'ADMIN', 'SUPER_ADMIN'] },
    { href: '/sales/daily', key: 'nav.reports.dailyLedger', roles: ['MANAGER', 'ADMIN', 'SUPER_ADMIN'] },
    { href: '/executive/insights', key: 'nav.reports.insights', roles: ['ADMIN', 'SUPER_ADMIN', 'MANAGER'] },
    { href: '/executive/compare', key: 'nav.reports.compareBranches', roles: ['ADMIN', 'SUPER_ADMIN', 'MANAGER'] },
    { href: '/executive/employees', key: 'nav.reports.teamPerformance', roles: ['ADMIN', 'SUPER_ADMIN', 'MANAGER'] },
  ],
};
