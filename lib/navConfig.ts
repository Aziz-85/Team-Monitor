...
const GROUP_SETTINGS: NavGroup = {
  ...
  items: [
    ...
    { href: '/sync/planner', key: 'nav.syncPlanner', roles: ['MANAGER', 'ADMIN', 'SUPER_ADMIN', 'AREA_MANAGER'] },
    { href: '/admin/integrations/planner', key: 'nav.plannerIntegration', roles: ['ADMIN', 'SUPER_ADMIN', 'AREA_MANAGER'] },
